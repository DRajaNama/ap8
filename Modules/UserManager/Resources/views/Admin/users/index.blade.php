...
<section class="content-header">
    <h1>
        Manage Users
        <small>Here you can manage the Users</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="{{url('admin/dashboard')}}"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="{{route('admin.usersmanager.index')}}" class="active">Users</a></li>
    </ol>
</section>
        ...
        <div class="col-md-12">
            <div class="box box-info">
                ...
                <div class="box-body table-responsive">
                    {{ Form::open(['url' => route('admin.usersmanager.index'),'method' => 'get']) }}
                                <div class="col-md-12">
                                <div class="row">
                    ...
                    <table class="table table-hover table-striped">
                        ...
                        <tbody>
                            ...
                            <tr class="row-{{ $user->id }}">
                                ...
                                <td>{{$user->phone}}</td>
                                <td>  @if ($user->status == 1)
                                        <span class='btn btn-success updateStatus' data-value="1" data-column="status" data-url="{{ route('admin.users.changeStatus',$user->id) }}">Active</span>
                                    @else
                                        <span class='btn btn-danger updateStatus' data-value="0" data-column="status" data-url="{{ route('admin.users.changeStatus',$user->id) }}">In-Active</span>
                                    @endif
                                </td>
                                ...
                                <td class="actions">
                                    ...
                                    <a href="{{ route('admin.users.view',$user->id)}}"
                                        class="btn btn-warning btn-sm" data-toggle="tooltip" alt="View Carriers"
