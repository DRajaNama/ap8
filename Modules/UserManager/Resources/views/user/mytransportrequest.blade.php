...
<div class="inner-bnr" style="background:url('../img/html-images/myaccount-bnr-img.jpg') no-repeat;">
    <div class="container">
        <h1><span>Transport</span> Requests</h1>
    </div>
</div>
<!--innerbnr-->
<!--breadcrumb-->
<div class="breadcrumb-outer">
    <div class="container">
        <ul class="breadcrumb">
            ...
            <li><span>Transport Requests</span></li>
        </ul>
    </div>
</div>
<!--breadcrumb-->
<div class="main-content sm-pad h-auto">
    <div class="container">
        ...
        {{ Form::open(['url' => route('myTransportRequest', $qparams),'method' => 'get']) }}
        <div class="load-filter quotes">
            ...
            <div class="wd7">
                ...
                <button class=" btn-lg btn-success filter" title="Search" type="submit"><i class="fa fa-filter"></i>
                    Filter</button>

            <a href="{{ route('myTransportRequest') }}" class="refresh-btn"><img src="{{ url('img/html-images/reload-icon.png')}}"
                    alt="refresh"></a>
                    ...
                    <tbody>
                        ...
                        <tr class="row-{{ $quote->id }}">
                            ...
                            <td>
                                ...
                                <span style="{{ ($quote->expire_date< date('d/m/Y') )?'color:red;':'' }}">
                                    {{  $quote->expire_date }} </span>
                            </td>
                            ...
                            <td> @if(empty($quote->quotations) || ($quote->quotations->count()==0))
                                  <span class="btn btn-success">Quotation Pending</span>
                                  @else
                                  @if($quote->quotations[0]['status']==0)
                                    <span class="btn btn-primary ">Pending</span>
                                    @endif

                                    @if($quote->quotations[0]['status']==1)
                                    <span class="btn btn-success ">Accepted</span>
                                    @endif
                                    @if($quote->quotations[0]['status']==2)
                            ...
                            <td class="actions">
                                ...
                                <a href="{{ route('quote.view',$quote->id)}}" class="btn btn-warning btn-sm"
                                    data-toggle="tooltip" alt="View quotes" title="" data-original-title="View"><i
                                        class="fa fa-fw fa-eye"></i></a>&nbsp;&nbsp;
                                        @if(!empty($quote->quotations)  && $quote->quotations->count()>0)

                                        <a href="{{ route('quotation.view',$quote->quotations[0]->id)}}" class="btn btn-warning btn-sm"
                                                data-toggle="tooltip" alt="View Quotation" title=""
                                                data-original-title="View Quotation"><i class="fa fa-fw fa-quote-left"></i></a>
                                                <a href="{{ route('quotation.edit',$quote->quotations[0]->id)}}" class="btn btn-warning btn-sm"
                                                        data-toggle="tooltip" alt="Edit Quotation" title=""
                                                        data-original-title="Edit Quotation"><i class="fa fa-fw fa-edit"></i></a>
                                        @else
                                <a href="{{ route('quote.quotationForm',$quote->id)}}" class="btn btn-warning btn-sm"
                                    data-toggle="tooltip" alt="Submit Quotation" title=""
                                    data-original-title="Submit Quotation"><i class="fa fa-fw fa-quote-left"></i></a>
@endif
