            ...
            <div class="col-md-7">
                <div class="box box-info">
                    <div class="box-header">
                        <h3 class="box-title"><span class="caption-subject font-green bold uppercase">{{ __('List Email Templates') }}</span></h3>
                        <div class="box-tools">
                            <!--a href="{{route('admin.email-templates.create')}}" class="btn btn-success btn-flat"><i class="fa fa-plus"></i>  New Email Template</a-->
                        </div>
                    </div><!-- /.box-header -->
