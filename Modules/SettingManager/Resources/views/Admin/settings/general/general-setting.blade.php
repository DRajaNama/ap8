                        ...
                        <div class="box-body table-responsive">
                            <table class="table table-hover table-striped">
                                ...
                                @foreach($settings as $setting)
									@if($setting->slug != 'ADMIN_PAGE_LIMIT' && $setting->slug != 'FRONT_PAGE_LIMIT' && $setting->slug != 'ADMIN_DATE_FORMAT' && $setting->slug != 'ADMIN_DATE_TIME_FORMAT' && $setting->slug != 'FRONT_DATE_FORMAT' && $setting->slug != 'FRONT_DATE_TIME_FORMAT')
                                    <tr>
                                        <td> {{$i}}. </td>
                                        <td>{{$setting->title}}</td>
                                        <td>{{$setting->slug}}</td>
